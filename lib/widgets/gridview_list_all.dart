...
class GridViewListAll extends StatelessWidget {
  GridViewListAll({super.key});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future:
          FirebaseFirestore.instance.collection("products").orderBy("time", descending: true).where("permission", isEqualTo: true).get(),
